...
$commandos_list = array(
    ...
    'port-write:', 'ifredirect:', 'persist:', 'file-cookie:', 'save-as:','ban:'
);
...
//echo  $opcoes['ban'];die();
$_SESSION['config']['blacklist'].= $opcoes['ban'];
...
function __main($dork, $motor, $cod) {
    ...
    $SESSION['ModClass'] = new ModClass(); //make ModClass global
